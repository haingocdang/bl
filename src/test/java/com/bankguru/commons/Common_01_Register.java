...
public class Common_01_Register extends AbstractTest {
	...
	public void beforeTest(String browserName, String url) {
		...
		registerPage.inputToEmailTextbox("haidang" + randomNumber() + "@yopmail.com");

		log.info("Pre-condition - STEP 03: Click Submit button");
		registerPage.clickToSubmitButton();

		log.info("Pre-condition - STEP 04: Get User ID");
		userIDValue = registerPage.getUserIDText();

		log.info("Pre-condition - STEP 05: Get Password");
